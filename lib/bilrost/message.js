 ...
 * @param {Object} properties - A message can have meta data added to it which relate to the transport, this
 ...
 */
function Message(content, properties, mockBus) {
  this.body = content || {};
...
Message.prototype.postTo = function(topic, callback) {
  this.bus
    .sendTopicMessage(topic, encode(this.body), (error, response) => {
      if (error) {
